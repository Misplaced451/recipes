    ...
    return (
        <div className="pt-6 section recipe">
            ...
            <div className="has-text-centered section pt-0">
                <h1 className="has-text-weight-bold is-size-3">Jerk Chicken Wings</h1>
                <p className="subtitle">Jerk wings that you can make at home</p>
            </div>
            ...
            spicy, just not unbearably so. If you like less spice, just use one pepper instead. As an additional tip, because this recipe uses an oven instead of a grill, you can add 
            a dash of liquid smoke to stand-in for the natural smoke flavor, but I prefer not to.
            </p>
            <p className='story'>
            Once your aromatics are blended, add in the brown sugar, allspice, cinnamon, nutmeg, and thyme. Bonus points if you use whole allspice (aka pimento) berries and thyme.
            However, this recipe was built around convenience for the average home cook, and because both allspice and thyme retain a lot of their strength in ground or dried forms 
            respectively, I usually go with the easier option. Note that when using fresh thyme, the stems are tough and woody, and won't blend very well, so you'll have to pick the 
            thyme leaves yourself. Once the spices are blended in, taste to check if the seasonings are to your liking. This marinade should be hot and sweet with an acidic tang, a  
            mellow allium flavor, and strong notes of allspice and thyme. If you find that the allspice or thyme are lacking in strength, add a little more to your preference.
            </p>
            <p className='story'>
            ...
            to taste, it's easier to estimate how much you'll need when seasoning the food directly. I then add them to a resealable plastic bag and pour in the marinade. I get in there 
            with my hands and rub down the wings thoroughly, ensuring that any part that can be coated will be coated fully. Once the bag is sealed, it goes in the fridge for 12 hours. 
            I know that's a long time to wait, but it's absolutely necessary for the chicken to absorb the flavor and to become tender. Once you see how juicy and soft the meat becomes, 
            you won't want to go any shorter. Waiting longer than 12 hours isn't really useful with pieces of meat this small, so I would cap it at 12 hours if possible.
            </p>
            <p className='story'>
