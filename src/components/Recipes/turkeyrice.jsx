    ...
    return (
        <div className="pt-6 section recipe">
            ...
            <div className="has-text-centered section pt-0">
                <h1 className="has-text-weight-bold is-size-3">Turkey Rice</h1>
                <p className="subtitle">Very nutritious, flavorful, and high in protein. I ate this a lot while bulking.</p>
            </div>
