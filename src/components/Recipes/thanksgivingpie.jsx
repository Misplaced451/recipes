...
const ThanksgivingPie = () => {
    return (
        ...
        description={'Your favorite Thanksgiving meals in one dish.'}
        instructions={
        ...
        <div className="story">
            <p>
            The classic Thankgiving feast, while delicious, is quite the daunting task to make. Wouldn't you rather capture the spirit of Thanksgiving all in one simple dish? What if I 
            told you there was a way to combine turkey, stuffing, gravy, peas, and mashed potatoes all in one dish? Well, let's say you used ground turkey instead of whole turkey. Let's 
            say you cooked it with aromatics and herbs that would normally go with the bread in stuffing, along with a roux and some chicken stock that would normally make a gravy. If 
            you top it with some cheesy mashed potatoes, what do you have? A shepherd's pie! Well, technically there's no lamb, so it's a cottage pie, but you get the idea. All the classic 
            smells and ingredients of a Thanksgiving meal, all tucked into one big casserole dish.
            </p>
            <p>
