    ...
    return (
        <div className="pt-6 section recipe">
            ...
            <div className="has-text-centered section pt-0">
                <h1 className="has-text-weight-bold is-size-3">Gnocchi</h1>
                <p className="subtitle">Potato dumplings that go great with brown butter and sage or tomato sauce.</p>
            </div>
