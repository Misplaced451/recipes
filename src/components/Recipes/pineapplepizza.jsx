...
const PineapplePizza = () => {
    return (
        ...
        description={'Don\'t let Italy find out about this one.'}
        instructions={
        ...
        <div className="story">
            <p>
            One time, I was asking my friends their opinion about pineapple on pizza. But in a weird game of word association, my brain combined the words "pineapple upside-down cake" 
            with "pineapple on pizza" and I ended up saying, “What do you think about pineapple upside-down pizza?” My friends were confused by this, but it got me thinking. What is 
            an upside-down pizza? If you think about it, pizza normally has sauce with cheese and toppings above it, whereas in deep-dish pizza, the cheese and toppings are under the 
            sauce. Even though the crust is always on the bottom, deep-dish pie is really the closest mainstream variant of pizza that could be considered “upside-down”. So what if 
            you made a pineapple upside-down cake, but instead of cake it was a deep-dish pizza? After hours of research, diagramming, and writing, I settled on a recipe for the first 
            ever Pineapple Upside-Down Deep-Dish Pizza. I'm proud to say, this is not only an original recipe, but also the first recipe for pineapple upside-down deep dish pizza ever 
            made. I've checked on Google, I've asked ChatGPT, there's nothing. I've seen pineapple on pizza, I've seen pineapple in deep-dish pizza, I've even seen a pineapple upside-down 
            pizza! But I've never seen pineapple upside-down deep dish pizza. This is the only place you can find it. Enjoy!
            </p>
            <p>
            Here's how it works: you take a pie dish and put down some pineapple rings in some melted butter with round slices of Italian sausage in the holes. Take deep-dish crust 
            dough and line the edges, then fill up the pie dish with tomato sauce, then a layer of toppings, and cheese on top. Cover the pie with a circle of dough and crimp the dough 
            onto the dough around the sides to seal it. Create a couple steam vents on the top and bake it in the oven. The best part is, while in the oven, because there's crust on the 
            top and sides of a pie dish, it looks like an ordinary pie to the casual observer. Wouldn't they be shocked to see that when you take it out of the oven and invert it, it was 
            a deep-dish pizza all along! I know you're asking, why even bake it upside down at all? It seems much simpler to do it right side up. You're right, but where's the fun in that? 
            Where's the adventure? The childlike whimsy that comes with making a cake that's actually a pizza that's actually a pie?
            </p>
            <p>
            ...
            20 minutes. The yeast will begin feeding on the sugars in the flour and start farting up a storm of carbon dioxide, which will cause the dough to rise. Knead the dough for 4 
            mins, rest for 4 mins, then knead for another 4. By the end of those 12 minutes, you should have a smooth, supple dough. Turn it into a ball, return it to the bowl and let it 
            rest for another 2 hours. Cover the top of the bowl with plastic wrap to prevent the dough from drying out.
            </p>
            <p>
            While that's rising, chop up your vegetables. I used onion, green bell pepper, and baby bella mushrooms. You can use more vegetables or none at all, it's up to you. Then grease 
            the pie dish liberally with butter and sprinkle parmesan on the bottom and sides. Add melted butter to the bottom with some canned pineapple rings. Cut some Italian sausage into 
            coins and fit them into the pineapple rings to mimic the maraschino cherries on a pineapple upside-down cake. If you're vegetarian, use whole black olives instead, and if you're 
            vegan, don't make this recipe. 
            </p>
            <p>
