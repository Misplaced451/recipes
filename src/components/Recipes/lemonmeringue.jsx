...
const LemonMeringue = () => {
    return (
        <div className="pt-6 section recipe">
            ...
            I started by learning to make a pâte brisée, none of this graham cracker business. If you're making a pie, at least use a pie dish and a proper pie crust. Second, people 
            complained that there was too much meringue, so I had to reduce that. I was also disappointed that the meringue left behind several unused egg yolks that I had no use for. That's 
            ...
            handheld whisk. I've tried it and it took forever. I thought my wrist would fall off and the meringue didn't even whip to stiff peaks in the end. Use a stand mixer or an electric mixer 
            if you have it. Once the whites are frothed up, begin gently sprinkling in the sugar. Too fast and it will deflate the meringue. Too slow and it won't all dissolve in time. Add it very 
            gradually and always keep whipping. Once all the sugar has been added, continue whipping until it reaches a stiff peaks stage. This means that if you dip a whisk in the meringue and hold 
