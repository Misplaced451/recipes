...
const Rajma = () => {
    return (
        <RecipeLayout 
        name={'Rajma'}
        description={'My personal favorite food.'}
        instructions={
        ...
        <div className="story">
            <p>
            If you could choose your last meal, what would you have? I know mine would be my mom's rajma, no contest. Rich, spicy gravy with ruby-red kidney beans poured lovingly over 
            a bed of white rice. That's the good stuff. It's nutritious, delicious, and incredibly filling. If my mom makes it, I just know I'm going to be eating rajma and rice for 
            lunch for the next 3 days. I'm sorry to say that you'll never make it as good as my mom. I can't do it either, that's for sure. But that shouldn't stop you from trying, 
            because even if you mess it up, it's hard to beat a dish that's this good.
            </p>
            <p>
            Start by preparing your kidney beans. After all, that's what “rajma” means in Hindi: kidney beans. If you're doing this the right way, you'll use a cup and a half of dry 
            kidney beans. You'll soak them in cold water overnight for about 10 hours before cooking with them. Of course, if you don't have time to soak the beans, you'll just use 2 
            cups of canned, pre-cooked kidney beans. You will, of course, save hours of time, but the trade-off is a major reduction in the texture and quality of the flavor. Unless 
            you're using canned beans, the most reliable way to cook beans is in a pressure cooker of some kind. This can be an instant pot or a traditional cooker. The pressure increases 
            the boiling point of water, allowing the beans to simmer at a much higher temperature. When exposed to this high temperature for an extended period of time, it will neturalize 
            the dangerous toxin present in most beans. Regular boiling will work, but it'll take hours. The higher heat that the pressure cooker provides ensures that the toxin-destroying 
            process only takes about 40 minutes.
            </p>
            <p>
            ...
            and move it occasionally. In the meantime, finely dice 2 tomatoes and add them once the onion is translucent along with 3 tablespoons coriander powder, 1 tablespoon cumin 
            powder, 1 teaspoon of fennel, and a pinch of salt. Do not skip any of these spices, omitting a single one will change the flavor completely, trust me. You may think that 
            adding cumin powder is unnecessary because we already added whole cumin seed earlier, but the powdered form changes the texture and develops flavor differently through the 
            cooking process compared to whole seeds. Once all the spices get mixed together, add turmeric and cayenne powder along with a spoonful of tomato paste. This will add flavor, 
            richness, and it'll speed up the cooking process a bit, since you don't have to cook the tomatoes as much. Stir as you cook, mashing the tomatoes until a paste-like consistency 
            is achieved. Once the paste begins leaking a little oil around the edges, that means the spices are cooked through. This may take a while, but it's crucial. If you feel that 
            the paste is too dry or getting burnt, add a little splash of water and continue cooking. If it still isn't leaking its oil, you may need a little extra oil to help it along.
            </p>
            <p>
