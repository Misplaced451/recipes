...
const Pizza = () => {
    return (
        <RecipeLayout 
        name={'Pizza'}
        description={'Ethan Chlebowski\'s recipe for quick, weeknight pizza.'}
        instructions={
        ...
        <div className="story">
            ...
            flour (if they are alive). If so, the yeast will begin foaming. If not, the yeast is dead. Start over with new yeast. Combine salt and flour in a large bowl, then add the 
            yeasty water to it. Combine by hand for 2 minutes until cohesive. This dough is very well hydrated, even for pizza, so it will be sticky. Be patient, stay calm, use flour to 
            get excess dough off your hands. Just trust the process. Cover and let the dough rest for 15 minutes.
            </p>
            <p>
            ...
            <p>
            Drizzle olive oil on it and fold it over on itself like you did before. Divide it in half, since this is enough for 2 pizzas. Form into balls on the counter, drizzle olive 
            oil into the bowl, and put the dough balls back in. Rest for another 30 minutes. Take out a ball, shape it into a pizza on your pizza cooking surface, top with sauce, cheese, 
