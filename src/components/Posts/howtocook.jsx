...
const StartCooking = () => {
    return (
        <div className="pt-6 tabcontent recipe section">
            ...
            <p className='has-text-centered subtitle is-4'>What Does it Mean to Be A Good Cook?</p>
            <p className='story'>
            ...
            trash can and recycling bin to toss waste. That's the bare minimum you need to safely prepare and eat food. Of course, it's impossible to make most dishes with just that, but there are countless cooking 
            gadgets out there. How do you know which ones to get?
            </p>
            <p className='story'>
            ...
            gimmicky gadgets and tacky tchotchkes out there that just take up space in your kitchen. Be smart about what you get, treat your tools with respect, and they'll respect you right back.
            </p>
            <p className='has-text-centered subtitle is-4 mt-6'>Where To Go From Here?</p>
            <p className='story'>
            ...
            and some of the history and science behind them as well. I didn't include his videos for the recipes or techniques. It was both for education and also for inspiration. His creative spark really comes through in that 
            ...
            you can reference at any time. A third option for the more science-geeky home cooks (like me) is <em>On Food And Cooking</em> by Harold McGee. It's a great reference for how to make the most of pretty much every type of 
            ingredient through both traditional and modern techniques, and I've seen it recommended by many Michelin-starred chefs. However, it might be a bit too technical, and the first two books I suggested are more than enough 
            for most people to get good at cooking. Although I fully endorse these books, I am also willing to admit they are not written in stone. We learn new things about food every day, and while the techniques do work in most 
            cases, there may be more modern techniques or understandings of certain preparations that have been improved over the years. Keep your mind open and question tradition, but always start with the tried and true to 
